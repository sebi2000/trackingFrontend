...
function Companies(props) {
    ...
    const onDeleteButton = id =>{
        ...
        axios.delete(`/companies/${id}`).then(resp => {
                    ...
                    {companies.map((company, index) => 
                        <TableRow>
                                ...
                                <div className={classes.actions}>
                                    <EditDialog type={'company'} data={company} getCompanies={() => getCompanies()}/>
                                    <ConfirmDialog type={'delete'} onDeleteButton={() => onDeleteButton(company._id)} />  
                                </div>
                                </TableCell>
                        </TableRow> )} 
                </TableBody> 
